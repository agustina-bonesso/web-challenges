...
const everyEmployeeHasFirstAndLastName = employees.every(
  (employee) => employee.lastName.length > 0 && employee.firstName.length > 0
);
...
const employeesSortedByAge = employees.sort(
  (employeeA, employeeB) => employeeB.age - employeeA.age
);
...
const employeesSortedByLastName = employees.sort(
  (employeeA, employeeB) => employeeB.lastName - employeeA.lastName
);
