...
const indexOfAnimalWithNameLongerFive = animals.indexOf(
  animals.find((animal) => animal.name.length > 5)
);
...
const animalsSortedByWeightReversed = animals
  .slice()
  .sort((animalA, animalB) => animalB.weight - animalA.weight);
