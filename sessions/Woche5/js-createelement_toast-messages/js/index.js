...
When clicking the "Add toast message" button a new entry should be appended to the toast messages container.
Create the HTML element for a new toast message with `document.createElement()`.
Have a look at the `index.html` to see the required HTML tag and class name.
...
addButton.addEventListener("click", () => {
  ...
  newToastMessage.innerHTML = `
  <p> A new toast message </p>
  `;
